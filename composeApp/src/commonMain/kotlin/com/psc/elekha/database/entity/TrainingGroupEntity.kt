...
data class TrainingGroupEntity(
    ...
    @ColumnInfo(name = "longitudeDay2") val longitudeDay2: Long?,
    @ColumnInfo(name = "longitudeDay1") val longitudeDay1: Long?,
    @ColumnInfo(name = "latitudeDay2") val latitudeDay2: Long?,
    @ColumnInfo(name = "latitudeDay1") val latitudeDay1: Long?,
    ...
    @ColumnInfo(name = "CurrentStatus") val CurrentStatus: Int?,
